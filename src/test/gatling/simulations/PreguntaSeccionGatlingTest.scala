...
/**
 * Performance test for the PreguntaSeccion entity.
 */
class PreguntaSeccionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PreguntaSeccion entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all preguntaSeccions")
            .get("/api/pregunta-seccions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created preguntaSeccion")
                .get("${new_preguntaSeccion_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created preguntaSeccion")
            .delete("${new_preguntaSeccion_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
